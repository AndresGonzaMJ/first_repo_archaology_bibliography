...
def mostrar_resultados(resultados):
    if resultados:
        ...
        result_window.configure(bg=COLORS['cornsilk']['DEFAULT'])  # Fondo igual que la ventana principal
        ...
        style.configure('Result.TFrame', background=COLORS['cornsilk']['DEFAULT'])  # Fondo igual que la ventana principal
        ...
        for resultado in resultados:
            ...
            autor_label = ttk.Label(content_frame, text=f"Por {resultado['AUTORES'].strip()}", font=('Segoe UI', 11), foreground=COLORS['tea_green']['200'], style='CardText.TLabel')
            autor_label.pack(anchor='w')

            anio_label = ttk.Label(content_frame, text=f"Año: {resultado['AÑO'].strip()}", font=('Segoe UI', 11), foreground=COLORS['tea_green']['200'], style='CardText.TLabel')
...
def pedir_datos():
    ...
    dialog.configure(bg=COLORS['cornsilk']['DEFAULT'])  # Fondo igual que la ventana principal

    style.configure('Dialog.TFrame', background=COLORS['cornsilk']['DEFAULT'])
    style.configure('Dialog.TLabel', font=('Montserrat', 14), foreground=COLORS['buff']['800'], background=COLORS['cornsilk']['DEFAULT'])
...
root.configure(bg=COLORS['cornsilk']['DEFAULT'])
...
style.configure('TFrame', background=COLORS['cornsilk']['DEFAULT'])
style.configure('Title.TLabel', font=('Montserrat', 18, 'bold'), foreground=COLORS['buff']['800'], background=COLORS['cornsilk']['DEFAULT'])
style.configure('Text.TLabel', font=('Segoe UI', 12), foreground=COLORS['tea_green']['200'], background=COLORS['cornsilk']['DEFAULT'])
