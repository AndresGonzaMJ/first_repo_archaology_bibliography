...
def mostrar_resultados(resultados):
    ...
    home_button = ttk.Button(result_window, text="Inicio", command=mostrar_bienvenida, style='Home.TButton')
...
def pedir_datos():
    ...
    style.configure('Back.TButton', font=('Segoe UI', 12, 'bold'), background=COLORS['cornsilk']['200'], foreground=COLORS['buff']['800'], padding=(5, 5))
...
style.configure('Home.TButton', font=('Segoe UI', 12, 'bold'), background=COLORS['buff']['DEFAULT'], foreground='white', padding=(10, 5), relief='flat')
...
style.map('Home.TButton',
         background=[('active', COLORS['buff']['800']), ('pressed', COLORS['buff']['DEFAULT'])],
