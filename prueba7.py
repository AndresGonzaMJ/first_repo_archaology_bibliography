...
def mostrar_resultados(resultados):
    if resultados:
        ...
        result_window.geometry("1100x700")  # Aumentar el tamaño de la ventana
        ...
        # Cargar la imagen y agregarla a la esquina superior derecha de la ventana de resultados
...
def pedir_datos():
    ...
    # Cargar la imagen y agregarla a la ventana del diálogo
    ...
    dialog_image_label = tk.Label(dialog, image=dialog_photo, bg=COLORS['papaya_whip']['DEFAULT'])
...
# Texto de crédito
credit_label = ttk.Label(root, text="Creado por: Andrés González", style='Credit.TLabel')
credit_label.pack()
credit_label.place(relx=0.5, rely=0.9, anchor='s')

# Cargar la imagen y agregarla a la interfaz
image_path = r"C:\Users\pc\Desktop\MAHPSA\images\Pieza arqueologica@2x.png"
image = Image.open(image_path)
image = image.resize((140, 260), Image.LANCZOS)
...
# Invertir la imagen horizontalmente para el lado derecho
